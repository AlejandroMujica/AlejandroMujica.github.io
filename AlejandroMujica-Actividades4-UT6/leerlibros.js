function gestionarFicheroXML(xmlDoc){
    ...
    document.getElementById('ficheroXML').innerHTML += "<b>" + xmlDoc.querySelector('nombre:nth-child(1)').textContent +
                                                               xmlDoc.querySelector('libro:nth-child(2)').textContent +
                                                               xmlDoc.querySelector('libro:nth-child(3)').textContent +
                                                               xmlDoc.querySelector('libro:nth-child(4)').textContent +
                                                               xmlDoc.querySelector('nombre:nth-child(2)').textContent +
